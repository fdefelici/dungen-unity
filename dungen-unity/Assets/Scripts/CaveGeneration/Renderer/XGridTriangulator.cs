...
public class XTriangulator {
    ...
    public class SquareGrid {
        ...
        public SquareGrid(int[,] map, float squareSize, Vector3 center) {
            ...
            for (int row = 0; row < rows; row++) {
                for (int col = 0; col < cols; col++) {
                    ...
                    controlNodes[row, col] = new ControlNode(pos, map[row, col] == XTile.WALL, squareSize);
                }
            }
