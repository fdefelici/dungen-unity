...
using System;
    ...
    struct XLocalPosition: IEquatable<XLocalPosition>
    {
        readonly int id;
        ...
        public XLocalPosition(int x, int y, int squarePoint)
        { 
        ...
        public bool Equals(XLocalPosition other)
        {
            return id == other.id;
        }
        ...
        {
            if (obj == null || !(obj is XLocalPosition))
            {
                return false;
            }
            else
            {
                return Equals((XLocalPosition)obj);
            }
        }
        ...
        public static bool operator ==(XLocalPosition a, XLocalPosition b)
        {
            return a.id == b.id;
        }
