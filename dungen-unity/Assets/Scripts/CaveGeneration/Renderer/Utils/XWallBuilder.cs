...
using System.Collections.Generic;
    ...
    public static class XWallBuilder
    {
    ...
    */
        ...
        public static Vector2[] GetUVs(List<Vector3[]> outlines, Vector3[] vertices)
        {
        ...
        public static int[] GetTriangles(List<Vector3[]> outlines)
        {
