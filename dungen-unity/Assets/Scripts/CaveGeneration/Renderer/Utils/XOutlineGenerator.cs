...
static class XOutlineGenerator
    {
    ...
    static void AddToOutline(List<XLocalPosition> outline, XLocalPosition item, HashSet<XLocalPosition> visited)
        ...
        static Vector3[] ToGlobalPositions(List<XLocalPosition> localPositions, int scale, Vector3 basePosition)
        {
        ...
        {
            readonly Dictionary<XLocalPosition, XLocalPosition> forwardLookup;
            readonly Dictionary<XLocalPosition, XLocalPosition> backwardLookup;

            public TwoWayLookup(int capacity)
            {
                forwardLookup = new Dictionary<XLocalPosition, XLocalPosition>(capacity);
                backwardLookup = new Dictionary<XLocalPosition, XLocalPosition>(capacity);
            }
            ...
            public bool TryGetForwardValue(XLocalPosition key, out XLocalPosition value)
            {
            ...
            public IEnumerable<KeyValuePair<XLocalPosition, XLocalPosition>> EnumerateForwards()
            {
            ...
            public IEnumerable<KeyValuePair<XLocalPosition, XLocalPosition>> EnumerateBackwards()
            {
